...
export class Menu {
   ...
   * board size, which colour — and those get a row on a panel somebody
   * opened in order to press Start. Everything else is a preference, and a
   * preference in front of somebody who wants to play is a question they did
   * not ask. A panel opened again is the short one again.
   */
