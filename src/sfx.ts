...
/** The stove sizzling through the cooking cinematic.
 *
 *  ~2.9s, which is longer than the cinematic holds the screen black (capped at 2.4s), so the
 *  tail carries over into the reveal — the pan is still going as the dish appears, which is
 *  what cooking sounds like. */
export const SFX_COOK = 'sfx-cooking';
