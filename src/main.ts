...
async function start(): Promise<void> {
   ...
   *  own status line and gear are already on. The number is the disc count,
   *  which is the whole argument of this game — and a reminder that being
   *  ahead on it in the middlegame usually means losing. */
    ...
    plates.set(
      {
        ...
        colour: 'black',
        meta: t('plate.discs', { n: counts.black }),
        active: yours,
      },
      {
        name: t('plate.engine'),
