...
function startGame(): void {
  createUmicatGame({
    ...
    scenes: [BootScene, BootMenuScene, GameScene, HotbarScene, WeatherScene, InventoryScene, PaletteScene, ConfirmScene, MailboxScene, ChestScene, OrderBookScene, BagScene, CursorScene],
    renderScripts,
  });
}
