...
function startGame(): void {
  createUmicatGame({
    ...
    scenes: [BootScene, BootMenuScene, SettingsScene, GameScene, HotbarScene, WeatherScene, PaletteScene, ConfirmScene, ReceiptScene, ChatterScene, MenuScene, CraftScene, DialogueScene, CursorScene, TransitionScene],
    renderScripts,
  });
}
