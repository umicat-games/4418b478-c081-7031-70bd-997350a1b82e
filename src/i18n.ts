...
const EN = {
  ...
  'lobby.failed': 'That did not work.',
  'lobby.tryAgain': 'Try again',
  'lobby.needSignIn': 'Online play needs you signed in.',
  'lobby.tooFast': 'Too many tries at once — wait a second.',
  ...
  'net.connectionLost': 'The connection to the table dropped.',
  'net.noSeat': 'Both seats are taken at this table.',
  'net.starting': 'Setting up the board…',
  'net.keepWaiting': 'Wait for someone',
  'net.emptySeat': 'nobody yet',
...
const ZH: Partial<Record<Key, string>> = {
  ...
  'lobby.failed': '没成功。',
  'lobby.tryAgain': '再试一次',
  'lobby.needSignIn': '联机需要先登录。',
  'lobby.tooFast': '点太快了,等一秒。',
  'net.yourMove': '轮到你',
  'net.theirMove': '轮到对方',
  ...
  'net.leave': '离开',
  'net.connecting': '连接中…',
  'net.connectionLost': '和这一桌的连接断了。',
  'net.noSeat': '这一桌两个位子都有人了。',
  'net.starting': '正在摆棋盘…',
  'net.keepWaiting': '继续等人',
  'net.emptySeat': '还没人',
