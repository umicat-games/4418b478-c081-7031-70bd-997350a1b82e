...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  'tut_plant_body': { en: 'Grab your seeds from the backpack again (Use), then tap the tilled soil to plant them.', 'zh-CN': '再去背包把种子拿出来（使用），然后点锄好的地把它种下去。' },
  'tut_water_head': { en: 'Water it', 'zh-CN': '浇水' },
  'tut_water_body': { en: 'Your watering can is empty! Open the wheel on the water to fill it, then come back and water your crop.', 'zh-CN': '水壶空了！在水边打开轮盘装满水，再回来给作物浇水。' },
  'tut_collect_head': { en: 'Pick a strawberry', 'zh-CN': '采草莓' },
  'tut_collect_body': { en: 'See the ripe strawberry bush? Open the wheel on it and collect the strawberries.', 'zh-CN': '看到那丛熟了的草莓了吗？在它上面打开轮盘，把草莓收下来。' },
