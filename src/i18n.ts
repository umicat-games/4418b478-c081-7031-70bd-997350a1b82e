...
const EN = {
  ...
  'hud.confirmHint': 'Drag it where you want it, right-click to turn it, then click the tick.',
  'hud.tapToPlace': 'Tap the board to put it down — it lands just above your finger.',
  'hud.confirmHintTouch': 'Now drag anywhere to move it, then tap the tick.',
  ...
  'act.zoomIn': 'Closer',
  'act.zoomOut': 'Further back',
  'confirm.yes': 'Yes',
  'confirm.no': 'No',
  'confirm.leaveYes': 'Leave',
  'confirm.passYes': 'Pass',
...
const ZH: Partial<Record<Key, string>> = {
  ...
  'hud.confirmHint': '拖动摆位置,右键转方向,然后点对勾落子。',
  'hud.tapToPlace': '点棋盘把它放下 —— 它会落在手指稍上方。',
  'hud.confirmHintTouch': '接着在屏幕任意处拖动就能挪它,然后点对勾落子。',
  'hud.wontGo': '这儿放不下。',
