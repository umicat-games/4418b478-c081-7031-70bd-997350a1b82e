...
const ZH: Partial<Record<Key, string>> = {
  ...
  'chat.marked': '标在棋盘上了。',
  'chat.midGame': '这一局还没下完——要开新的一局，用左下角的齿轮。',
  'chat.markFailed': '我没能在棋盘上找到「{squares}」——再问我一次，我会指对地方。',
  'chat.attacks': '{square}：被 {attackers} 攻击，被 {defenders} 保护。已标在棋盘上。',
  'chat.attacksNothing': '没有',
  'chat.moves': '{square} 上的{piece}有 {count} 个合法走法：{moves}。',
  'chat.movesNone': '{square} 上的棋子无处可走。',
  'chat.notASquare': '「{square}」不是这个棋盘上的格子。',
  'chat.coach': '陪练',
  'chat.ask': '问陪练…',
  'chat.tap': '点开',
  'chat.close': '收起',
