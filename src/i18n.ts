...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  // Forced new-game tutorial — one overlay prompt per step (heading + body).
  tut_heading: { en: "Let's learn!", 'zh-CN': '一起学一学吧！' },
  ...
  'tut_take-seeds_body': { en: 'Tap the carrot seeds, then choose Take to move them into your backpack.', 'zh-CN': '点一下胡萝卜种子，选「取出」把它们放进背包。' },
