...
- **饥饿**：孩子有饥饿值，不喂食会逐渐降低体力，持续一段时间后进入"虚弱"状态
- **虚弱**：孩子不再主动活动，只躺着，AI 对话变少、声音变小，这是最后的警示
- **离世**：长期极端忽视（非偶尔没上线，而是真正的断绝照料）会导致孩子去世，留下墓地，游戏进入"新的孩子"流程
- **缓冲机制**：系统在孩子进入虚弱状态前会通过通知/邮件提醒玩家，死亡不会毫无预警
- **"离家出走"替代选项**：设计中可讨论——极端忽视导致的不是死亡，而是孩子"出走去了别的岛"，留下一封手写信，情感冲击同样强烈，但没有永久失去的感觉
...
**实时模式（主动发起）**：
- 玩家可发起"拜访邀请"，双方同时在线时，两个孩子出现在同一张地图上
- 两个玩家各自只能通过孩子交流（不能直接发消息给对方），维持游戏内的沉浸感
- 两个孩子的 AI 可以互相对话，玩家从旁观看，偶尔给自己的孩子"提示"
...
- [x] 游戏名字：**Catopia**
- [ ] 孩子"去世"还是"离家出走"——哪种结局更符合游戏基调？
- [ ] 孩子的初始名字：玩家命名 / 孩子自己取 / 随机生成？
- [ ] 贷款系统的利率和还款机制细节
- [ ] 实时拜访的地图是哪个岛？混合在同一张地图还是有专属拜访场景？
